...
export default function Nav() {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-10 flex h-12 w-full items-center justify-start gap-3 bg-fs-tan/85 px-4 shadow-lg backdrop-blur-sm sm:justify-center">
